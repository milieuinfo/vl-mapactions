...
describe('show info action', function() {
	const map, showInfoAction, feature, source, mapWasRerendered;
	...
	beforeEach(function() {
		...
		showInfoAction = new ShowInfoAction({getSource: function() {return source;}}, infoPromise, 'loading message');
	...
	it('er wordt een loading message getoond als de promise er lang over doet om zijn resultaat te resolven', function(done) {
		...
		showInfoAction = new ShowInfoAction({getSource: function() {return  new SourceVector({});}}, infoPromise, 'loading message');
		showInfoAction.map = map;
    ...
    it('een meegegeven offset wordt gebruikt', function(done) {
        ...
        showInfoAction = new ShowInfoAction({getSource: function() {return  new SourceVector({});}}, infoPromise, 'loading message', { offset: [0, 0] });
        showInfoAction.map = map;
