...
describe('show info select action', function() {
	const map, showInfoSelectAction, feature, source, doneFunctionCalled, visibility, mapWasRerendered;
	...
	beforeEach(function() {
		...
		showInfoSelectAction = new ShowInfoSelectAction({getSource: function() {return source;}, setVisible: function(visible) {visibility = visible;}, getVisible: function() {return visibility;}}, infoPromise, 'loading message', function(){
	...
	it('zet een overlay op de map wanneer punt getekend werd, met daarin inhoud van de promise', function(done) {
		...
		waitFor(contentShown, function() {
			expect(map.overlays[0].getPosition()).to.equal([0, 0]);
	...
	it('er wordt een loading message getoond als de promise er lang over doet om zijn resultaat te resolven', function(done) {
		...
		showInfoSelectAction = new ShowInfoSelectAction({getSource: function() {return  new SourceVector();}, setVisible: function() {}, getVisible: function() {}}, infoPromise, 'loading message', function(){});
		showInfoSelectAction.map = map; 
    ...
    it('een meegegeven offset wordt gebruikt', function(done) {
        ...
        showInfoSelectAction = new ShowInfoSelectAction({getSource: function() {return  new SourceVector();}, setVisible: function() {}, getVisible: function() {}}, infoPromise, 'loading message', function(){}, { offset: [0, 0] });
        showInfoSelectAction.map = map;
