# vl-mapactions
![GitHub issues](https://img.shields.io/github/issues-raw/milieuinfo/webcomponent-vl-mapactions) ![GitHub pull requests](https://img.shields.io/github/issues-pr-raw/milieuinfo/webcomponent-vl-mapactions) ![GitHub release (latest SemVer)](https://img.shields.io/github/v/release/milieuinfo/webcomponent-vl-mapactions)

Map acties voor OpenLayers
...
## Versionering
We gebruiken [Semantic Versioning](https://semver.org) en voorzien elke release van release notes, zie een overzicht van de [releases](https://github.com/milieuinfo/webcomponent-vl-mapactions/releases).
...
## Credits
Zie de lijst van [ontwikkelaars](https://github.com/milieuinfo/webcomponent-vl-mapactions/graphs/contributors) die meegewerkt hebben aan de webcomponent.
